...
def mobile_session_get_sqlinstance(context):
    '''
...
def mobile_session_query_on_db(context, sql_instance_country_query: dict):
...
def mobile_session_job():
    instances = mobile_session_get_sqlinstance()
    instances.map(mobile_session_query_on_db).collect()
