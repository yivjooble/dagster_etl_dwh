...
TABLE_NAME = "balkans_session_cnt_by_traff_source"
SCHEMA = "balkans"
...
PROCEDURE_CALL = "call an.prc_balkans_session_cnt_by_traff_source(%s);"
...
def balkans_session_cnt_by_traff_source_get_sqlinstance(context):
    '''
...
def balkans_session_cnt_by_traff_source_query_on_db(context, sql_instance_country_query: dict):
...
def balkans_session_cnt_by_traff_source_job():
    instances = balkans_session_cnt_by_traff_source_get_sqlinstance()
    instances.map(balkans_session_cnt_by_traff_source_query_on_db).collect()
