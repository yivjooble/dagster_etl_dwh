...
TABLE_NAME = "account_revenue_abtest_agg"
SCHEMA = "aggregation"
...
PROCEDURE_CALL = "call an.prc_account_revenue_abtest_agg(%s);"
...
def account_revenue_abtest_agg_get_sql_instance(context):
    '''
...
def account_revenue_abtest_agg_job():
    instances = account_revenue_abtest_agg_get_sql_instance()
    instances.map(account_revenue_abtest_agg_query_on_db).collect()
