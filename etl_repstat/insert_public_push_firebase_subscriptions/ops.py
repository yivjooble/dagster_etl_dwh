...
TABLE_NAME = "push_firebase_subscriptions"
SCHEMA = "public"

PROCEDURE_CALL = "call an.prc_insert_public_push_firebase_subscriptions();"
...
def prc_push_firebase_subscriptions_get_sqlinstance(context):
...
def prc_push_firebase_subscriptions_query_on_db(context, sql_instance_country_query: dict):
...
def prc_insert_public_push_firebase_subscriptions_job():
    instances = prc_push_firebase_subscriptions_get_sqlinstance()
    instances.map(prc_push_firebase_subscriptions_query_on_db)
