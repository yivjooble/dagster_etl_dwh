...
TABLE_NAME = "impression_statistic"
SCHEMA = "aggregation"
...
PROCEDURE_CALL = "call an.prc_impression_statistic(%s);"
...
def impression_statistic_get_sqlinstance(context):
    '''
...
def impression_statistic_query_on_db(context, sql_instance_country_query: dict):
...
def impression_statistic_job():
    instances = impression_statistic_get_sqlinstance()
    instances.map(impression_statistic_query_on_db).collect()
