...
PROCEDURE_CALL = "call an.prc_click_data_agg(%s);"
...
def click_data_agg_get_sql_instance(context):
    '''
...
def click_data_agg_job():
    instances = click_data_agg_get_sql_instance()
    instances.map(click_data_agg_query_on_db).collect()
