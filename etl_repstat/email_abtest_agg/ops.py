...
def email_abtest_agg_get_sqlinstance(context):
    '''
...
def email_abtest_agg_job_yesterday_date():
    instances = email_abtest_agg_get_sqlinstance()
    instances.map(email_abtest_agg_query_on_db).collect()
...
def email_abtest_agg_job_current_date():
    instances = email_abtest_agg_get_sqlinstance()
    instances.map(email_abtest_agg_query_on_db)
