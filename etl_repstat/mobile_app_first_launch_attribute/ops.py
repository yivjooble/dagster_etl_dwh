...
TABLE_NAME = "mobile_app_first_launch_attribute"
SCHEMA = "an"

PROCEDURE_CALL = "call an.prc_first_launch_attribute();"
...
def prc_first_launch_attribute_get_sqlinstance(context):
...
def prc_first_launch_attribute_query_on_db(context, sql_instance_country_query: dict):
...
@job(
    ...
    metadata={
        ...
        "triggered_by_job": "dwh__mobile_app_first_launch_attribute"
    },
    description=f'{SCHEMA}.{TABLE_NAME}',
)
def prc_first_launch_attribute_job():
    instances = prc_first_launch_attribute_get_sqlinstance()
    instances.map(prc_first_launch_attribute_query_on_db)
