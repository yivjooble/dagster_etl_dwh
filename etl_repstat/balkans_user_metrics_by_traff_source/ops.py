...
TABLE_NAME = "balkans_user_metrics_by_traff_source"
SCHEMA = "balkans"
...
PROCEDURE_CALL = "call an.prc_balkans_user_metrics_by_traff_source(%s);"
...
CUSTOM_COUNTRY_LIST = ['rs', 'ba', 'hr', 'gr']


@op(out=DynamicOut(), required_resource_keys={'globals'})
def balkans_user_metrics_by_traff_source_get_sqlinstance(context):
    '''
...
def balkans_user_metrics_by_traff_source_query_on_db(context, sql_instance_country_query: dict):
...
def balkans_user_metrics_by_traff_source_job():
    instances = balkans_user_metrics_by_traff_source_get_sqlinstance()
    instances.map(balkans_user_metrics_by_traff_source_query_on_db).collect()
