...
# Define constants
TABLE_NAME = "serp_campaign_rivals_agg"
SCHEMA = "aggregation"
...
PROCEDURE_CALL = "call an.prc_serp_campaign_rivals_agg(%s);"
...
def serp_campaign_rivals_agg_get_sql_instance(context):
    '''
...
def serp_campaign_rivals_agg_query_on_db(context, sql_instance_country_query: dict):
    """
...
def serp_campaign_rivals_agg_job():
    instances = serp_campaign_rivals_agg_get_sql_instance()
    instances.map(serp_campaign_rivals_agg_query_on_db).collect()
