...
TABLE_NAME = "ea_search_conversion"
SCHEMA = "traffic"
...
PROCEDURE_CALL = "call an.prc_ea_search_conversion(%s);"
...
CUSTOM_COUNTRY_LIST = ['rs']


@op(out=DynamicOut(), required_resource_keys={'globals'})
def ea_search_conversion_get_sqlinstance(context):
    '''
...
def ea_search_conversion_query_on_db(context, sql_instance_country_query: dict):
...
def ea_search_conversion_job():
    instances = ea_search_conversion_get_sqlinstance()
    instances.map(ea_search_conversion_query_on_db).collect()
