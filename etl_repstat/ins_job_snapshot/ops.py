...
PROCEDURE_CALL = "call an.prc_insert_job_snapshot();"
...
def prc_insert_job_snapshot_get_sqlinstance(context):
...
def prc_insert_job_snapshot_query_on_db(context, sql_instance_country_query: dict):
...
def prc_insert_job_snapshot_job():
    instances = prc_insert_job_snapshot_get_sqlinstance()
    instances.map(prc_insert_job_snapshot_query_on_db)
