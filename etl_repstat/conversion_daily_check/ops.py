...
def conversion_daily_check_get_sqlinstance(context):
    '''
...
def conversion_daily_check_query_on_db(context, sql_instance_country_query: dict):
...
def conversion_daily_check_job():
    instances = conversion_daily_check_get_sqlinstance()
    instances.map(conversion_daily_check_query_on_db).collect()
