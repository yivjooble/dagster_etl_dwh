...
TABLE_NAME = "scheduled_operation"
SCHEMA = "imp"
...
def scheduled_operation_get_sqlinstance(context):
    """
...
def scheduled_operation_query_on_db(context, sql_instance_country_query: dict):
    """
...
def scheduled_operation_job():
    instances = scheduled_operation_get_sqlinstance()
    instances.map(scheduled_operation_query_on_db)
