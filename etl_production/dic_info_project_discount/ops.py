...
TABLE_NAME = "dic_info_project_discount"
SCHEMA = "dimension"
...
def dic_info_project_discount_get_sqlinstance(context):
    """
...
def dic_info_project_discount_query_on_db(context, sql_instance_country_query: dict):
    """
...
def dic_info_project_discount_job():
    instances = dic_info_project_discount_get_sqlinstance()
    instances.map(dic_info_project_discount_query_on_db)
