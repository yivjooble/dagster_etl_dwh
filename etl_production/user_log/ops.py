...
def user_log_get_sqlinstance(context):
    """
...
def user_log_query_on_db(context, sql_instance_country_query: dict):
    """
...
def user_log_job():
    instances = user_log_get_sqlinstance()
    instances.map(user_log_query_on_db)
