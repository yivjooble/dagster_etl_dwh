...
TABLE_NAME = "campaign_auto_esc_stopped"
SCHEMA = "auction"
...
def campaign_auto_esc_stopped_get_sqlinstance(context):
    """
...
def campaign_auto_esc_stopped_query_on_db(context, sql_instance_country_query: dict):
    """
...
def campaign_auto_esc_stopped_job():
    instances = campaign_auto_esc_stopped_get_sqlinstance()
    instances.map(campaign_auto_esc_stopped_query_on_db)
