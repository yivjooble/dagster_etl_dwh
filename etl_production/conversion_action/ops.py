...
def conversion_action_get_sql_instance(context):
    """
...
def conversion_action_launch_query_on_db(context, sql_instance_country_query: dict):
    """
...
def conversion_action_job():
    instances = conversion_action_get_sql_instance()
    instances.map(conversion_action_launch_query_on_db)
