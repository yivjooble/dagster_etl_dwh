...
def banner_limit_get_sqlinstance(context):
    """
...
def banner_limit_query_on_db(context, sql_instance_country_query: dict):
    """
...
def banner_limit_job():
    instances = banner_limit_get_sqlinstance()
    instances.map(banner_limit_query_on_db)
