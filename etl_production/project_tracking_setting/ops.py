...
TABLE_NAME = "project_tracking_setting"
SCHEMA = "dimension"
...
def project_tracking_setting_get_sqlinstance(context):
    """
...
def project_tracking_setting_query_on_db(context, sql_instance_country_query: dict):
    """
...
def project_tracking_setting_job():
    instances = project_tracking_setting_get_sqlinstance()
    instances.map(project_tracking_setting_query_on_db)
