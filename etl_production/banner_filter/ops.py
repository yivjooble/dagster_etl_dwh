...
def banner_filter_get_sqlinstance(context):
    """
...
def banner_filter_query_on_db(context, sql_instance_country_query: dict):
    """
...
def banner_filter_job():
    instances = banner_filter_get_sqlinstance()
    instances.map(banner_filter_query_on_db)
