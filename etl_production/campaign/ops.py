...
def campaign_get_sqlinstance(context):
    """
...
def campaign_query_on_db(context, sql_instance_country_query: dict):
    """
...
def campaign_job():
    instances = campaign_get_sqlinstance()
    instances.map(campaign_query_on_db)
