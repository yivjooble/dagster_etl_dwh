...
def user_budget_log_get_sqlinstance(context):
    """
...
def user_budget_log_query_on_db(context, sql_instance_country_query: dict):
    """
...
def user_budget_log_job():
    instances = user_budget_log_get_sqlinstance()
    instances.map(user_budget_log_query_on_db)
