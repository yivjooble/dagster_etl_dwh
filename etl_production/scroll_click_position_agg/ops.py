...
def scroll_click_position_get_sqlinstance(context):
    '''
...
def scroll_click_position_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def scroll_click_position_agg_job():
    instances = scroll_click_position_get_sqlinstance()
    instances.map(scroll_click_position_query_on_db)
