...
def info_project_get_sqlinstance(context):
    """
...
def info_project_query_on_db(context, sql_instance_country_query: dict):
    """
...
def info_project_job():
    instances = info_project_get_sqlinstance()
    instances.map(info_project_query_on_db)
