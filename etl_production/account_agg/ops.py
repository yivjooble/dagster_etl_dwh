...
def account_agg_get_sqlinstance(context):
    """
...
def account_agg_query_on_db(context, sql_instance_country_query: dict):
    """
    ...
    try:
        ...
        if not file_paths:
            ...
            def execute(context,
                ...
                context.log.info(f'|{country_code.upper()}|: Successfully saved df to {destination_db}.')
...
def account_agg_job():
    instances = account_agg_get_sqlinstance()
    instances.map(account_agg_query_on_db)
