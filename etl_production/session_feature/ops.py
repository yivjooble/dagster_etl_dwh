...
def session_feature_get_sqlinstance(context):
    """
...
def session_feature_query_on_db(context, sql_instance_country_query: dict):
    """
...
def session_feature_job():
    instances = session_feature_get_sqlinstance()
    instances.map(session_feature_query_on_db)
