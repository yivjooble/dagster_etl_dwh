...
TABLE_NAME = "additional_pages_click_daily_agg"
SCHEMA = "aggregation"
...
def additional_pages_click_daily_agg_get_sqlinstance(context):
    '''
...
def additional_pages_click_daily_agg_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def additional_pages_click_daily_agg_job():
    instances = additional_pages_click_daily_agg_get_sqlinstance()
    instances.map(additional_pages_click_daily_agg_query_on_db)
