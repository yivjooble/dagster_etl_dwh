...
def site_manager_get_sqlinstance(context):
    """
...
def site_manager_query_on_db(context, sql_instance_country_query: dict):
    """
...
def site_manager_job():
    instances = site_manager_get_sqlinstance()
    instances.map(site_manager_query_on_db)
