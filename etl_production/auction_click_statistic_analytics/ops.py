...
TABLE_NAME = "auction_click_statistic_analytics"
SCHEMA = "aggregation"
DATE_COLUMN = "date"
...
def auction_click_statistic_analytics_get_sqlinstance(context):
    '''
...
def auction_click_statistic_analytics_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def auction_click_statistic_analytics_job():
    instances = auction_click_statistic_analytics_get_sqlinstance()
    instances.map(auction_click_statistic_analytics_query_on_db)
