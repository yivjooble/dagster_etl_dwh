...
def campaign_feature_get_sqlinstance(context):
    """
...
def campaign_feature_query_on_db(context, sql_instance_country_query: dict):
    """
...
def campaign_feature_job():
    instances = campaign_feature_get_sqlinstance()
    instances.map(campaign_feature_query_on_db)
