...
CUSTOM_COUNTRIES_LIST = [
    'us', 'de', 'ca', 'ua', 'uk', 'fr', 'pl', 'es', 'at', 'be', 'br', 'ch', 'cl', 'hr', 'it',
    'nl', 'co', 'se', 'tr', 'id', 'mx', 'ro', 'pt', 'cz', 'ar', 'pe', 'pr', 'do', 'uy', 'hu',
    'in', 'rs', 'gr'
]
...
def seo_ab_prod_metrics_get_sql_instance(context):
    """
...
def seo_ab_prod_metrics_query_on_db(context, sql_instance_country_query: dict):
    """
...
def seo_ab_prod_metrics_job():
    instances = seo_ab_prod_metrics_get_sql_instance()
    instances.map(seo_ab_prod_metrics_query_on_db).collect()
