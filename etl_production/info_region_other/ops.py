...
def info_region_other_get_sqlinstance(context):
    '''
...
def info_region_other_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def info_region_other_job():
    instances = info_region_other_get_sqlinstance()
    instances.map(info_region_other_query_on_db)
