...
def auction_user_get_sqlinstance(context):
    """
...
def auction_user_query_on_db(context, sql_instance_country_query: dict):
    """
...
def auction_user_job():
    instances = auction_user_get_sqlinstance()
    instances.map(auction_user_query_on_db)
