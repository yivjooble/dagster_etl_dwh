...
TABLE_NAME = "banner_stat_history"
SCHEMA = "traffic"
...
CUSTOM_COUNTRY_LIST = ['de', 'fr', 'pl', 'it', 'es', 'ca', 'us', 'uk', 'br', 'nl', 'at', 'ch', 'be', 'mx', 'cz']


@op(out=DynamicOut(), required_resource_keys={'globals'})
def banner_stat_history_get_sqlinstance(context):
    """
...
def banner_stat_history_query_on_db(context, sql_instance_country_query: dict):
    """
...
def banner_stat_history_job():
    instances = banner_stat_history_get_sqlinstance()
    instances.map(banner_stat_history_query_on_db)
