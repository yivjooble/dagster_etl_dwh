...
def site_get_sqlinstance(context):
    """
...
def site_query_on_db(context, sql_instance_country_query: dict):
    """
...
def site_job():
    instances = site_get_sqlinstance()
    instances.map(site_query_on_db)
