...
def auction_campaign_get_sqlinstance(context):
    """
...
def auction_campaign_query_on_db(context, sql_instance_country_query: dict):
    """
...
def auction_campaign_job():
    instances = auction_campaign_get_sqlinstance()
    instances.map(auction_campaign_query_on_db)
