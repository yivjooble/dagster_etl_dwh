...
def session_test_get_sqlinstance(context):
    """
...
def session_test_query_on_db(context, sql_instance_country_query: dict):
    """
    ...
    try:
        ...
        operation_date_start = get_datediff(context.resources.globals["reload_date_start"])
        operation_date_end = get_datediff(context.resources.globals["reload_date_end"])
...
def session_test_job():
    instances = session_test_get_sqlinstance()
    instances.map(session_test_query_on_db)
