...
TABLE_NAME = "salary_page_click_daily_agg"
SCHEMA = "aggregation"
...
def salary_page_click_daily_agg_get_sqlinstance(context):
    '''
...
def salary_page_click_daily_agg_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def PRD_salary_page_click_daily_agg_job():
    instances = salary_page_click_daily_agg_get_sqlinstance()
    instances.map(salary_page_click_daily_agg_query_on_db)
