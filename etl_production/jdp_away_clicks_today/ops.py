...
TABLE_NAME = "jdp_away_clicks_today"
SCHEMA = "aggregation"
...
def jdp_away_clicks_today_get_sqlinstance(context):
    """
...
def jdp_away_clicks_today_query_on_db(context, sql_instance_country_query: dict):
    """
...
@job(
    ...
    tags={"data_model": f"{SCHEMA}", "truncate": "True"},
    metadata={
...
def jdp_away_clicks_today_job():
    instances = jdp_away_clicks_today_get_sqlinstance()
    instances.map(jdp_away_clicks_today_query_on_db)
