...
TABLE_NAME = "adv_revenue_by_placement_and_src"
SCHEMA = "imp"
...
def adv_revenue_by_placement_and_src_get_sqlinstance(context):
    '''
...
def adv_revenue_by_placement_and_src_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def adv_revenue_by_placement_and_src_job():
    instances = adv_revenue_by_placement_and_src_get_sqlinstance()
    instances.map(adv_revenue_by_placement_and_src_query_on_db)
