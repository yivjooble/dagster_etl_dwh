...
def info_currency_get_sqlinstance(context):
    """
...
def info_currency_query_on_db(context, sql_instance_country_query: dict):
    """
...
def info_currency_job():
    instances = info_currency_get_sqlinstance()
    instances.map(info_currency_query_on_db)
