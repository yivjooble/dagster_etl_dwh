...
def jobs_stat_hourly_get_sqlinstance(context):
    '''
...
def jobs_stat_hourly_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def jobs_stat_hourly_job():
    instances = jobs_stat_hourly_get_sqlinstance()
    instances.map(jobs_stat_hourly_query_on_db)
