...
SCHEMA = "aggregation"
DATE_DIFF_COLUMN = "job_view_datediff"
...
def project_job_apply_agg_get_sql_instance(context):
    """
...
def project_job_apply_agg_query_on_db(context, sql_instance_country_query: dict):
    """
...
def project_job_apply_agg_job():
    instances = project_job_apply_agg_get_sql_instance()
    instances.map(project_job_apply_agg_query_on_db).collect()
