...
TABLE_NAME = "general_feed_ignored_projects"
SCHEMA = "imp"
...
def general_feed_ignored_projects_get_sqlinstance(context):
    """
...
def general_feed_ignored_projects_query_on_db(context, sql_instance_country_query: dict):
    """
...
def general_feed_ignored_projects_job():
    instances = general_feed_ignored_projects_get_sqlinstance()
    instances.map(general_feed_ignored_projects_query_on_db)
