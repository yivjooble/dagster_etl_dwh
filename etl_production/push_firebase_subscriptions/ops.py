...
def push_firebase_subscriptions_get_sqlinstance(context):
    '''
...
def push_firebase_subscriptions_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def push_firebase_subscriptions_job():
    instances = push_firebase_subscriptions_get_sqlinstance()
    instances.map(push_firebase_subscriptions_query_on_db)
