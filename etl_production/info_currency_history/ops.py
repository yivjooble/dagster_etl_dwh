...
TABLE_NAME = "info_currency_history"
SCHEMA = "dimension"
...
def info_currency_history_get_sqlinstance(context):
    """
...
def info_currency_history_query_on_db(context, sql_instance_country_query: dict):
    """
...
def info_currency_history_job():
    instances = info_currency_history_get_sqlinstance()
    instances.map(info_currency_history_query_on_db)
