...
# Define setting
SCHEMA = "dwh"
TABLE_NAME = "v_click_data_agg"  # name of table in Clickhouse
...
def v_click_data_agg_create_dict_params(context):
    """
...
@op(retry_policy=retry_policy,
    required_resource_keys={'globals'})
def v_click_data_agg_save_data_as_pkl(context, dict_params: dict):
    """
...
@job(config=job_config,
     ...
     description="Load v_click_data_agg table from clouderry database to Clickhouse",
...
def v_click_data_agg_job():
    ...
    create_dict_params = v_click_data_agg_create_dict_params()
    # save data from history database as pkl to /data
    create_dict_params.map(v_click_data_agg_save_data_as_pkl).collect()
