...
TABLE_NAME = 'paid_labels_channel'
SCHEMA = 'traffic'

CURRENT_DATE = datetime.now().date().strftime('%Y-%m-%d')

PROCEDURE_CALL = 'call traffic.prc_insert_paid_labels_channel(%s);'
...
def paid_labels_channel_query_on_db(context):
...
def paid_labels_channel_job():
    paid_labels_channel_query_on_db()
