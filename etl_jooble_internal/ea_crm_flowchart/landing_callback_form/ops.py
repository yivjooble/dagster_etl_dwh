...
TABLE_NAME = "landing_callback_form"
SCHEMA = "imp_employer"
...
@op(out=DynamicOut())
def landing_callback_form_get_sqlinstance(context):
    '''
...
def landing_callback_form_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def landing_callback_form_job():
    instances = landing_callback_form_get_sqlinstance()
    instances.map(landing_callback_form_query_on_db)
