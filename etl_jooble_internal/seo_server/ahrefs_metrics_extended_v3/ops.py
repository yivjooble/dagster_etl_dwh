...
TABLE_NAME = "ahrefs_metrics_extended_v3"
SCHEMA = "traffic"
...
@op(out=DynamicOut())
def ahrefs_metrics_extended_v3_get_sqlinstance(context):
    '''
...
def ahrefs_metrics_extended_v3_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def ahrefs_metrics_extended_v3_job():
    instances = ahrefs_metrics_extended_v3_get_sqlinstance()
    instances.map(ahrefs_metrics_extended_v3_query_on_db)
