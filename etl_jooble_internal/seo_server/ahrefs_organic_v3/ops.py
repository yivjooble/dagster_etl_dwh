...
@op(out=DynamicOut())
def ahrefs_organic_v3_get_sqlinstance(context):
    '''
...
def ahrefs_organic_v3_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def ahrefs_organic_v3_job():
    instances = ahrefs_organic_v3_get_sqlinstance()
    instances.map(ahrefs_organic_v3_query_on_db)
