...
def ea_job_to_uid_mapping_query_on_db(context):
...
@job(
    ...
    description=f'{TABLE_NAME}.{SCHEMA}',
)
def ea_job_to_uid_mapping_job():
    ea_job_to_uid_mapping_query_on_db()
