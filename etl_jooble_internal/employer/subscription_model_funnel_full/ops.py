...
TABLE_NAME = "subscription_model_funnel_full"
SCHEMA = "aggregation"
...
@op(out=DynamicOut())
def subscription_model_funnel_full_get_sqlinstance(context):
    """
...
def subscription_model_funnel_full_query_on_db(context, sql_instance_country_query: dict):
    """
...
def subscription_model_funnel_full_job():
    db_instances = subscription_model_funnel_full_get_sqlinstance()
    db_instances.map(subscription_model_funnel_full_query_on_db)
