...
@op(out=DynamicOut())
def balkans_trials_get_sqlinstance(context):
    """
...
def balkans_trials_query_on_db(context, sql_instance_country_query: dict):
    """
...
def balkans_trials_job():
    db_instances = balkans_trials_get_sqlinstance()
    db_instances.map(balkans_trials_query_on_db)
