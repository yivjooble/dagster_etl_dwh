...
TABLE_NAME = "balkans_subscriptions_with_payments"
SCHEMA = "balkans"
...
@op(out=DynamicOut())
def balkans_subscriptions_with_payments_get_sqlinstance(context):
    """
...
def balkans_subscriptions_with_payments_query_on_db(context, sql_instance_country_query: dict):
    """
...
def balkans_subscriptions_with_payments_job():
    db_instances = balkans_subscriptions_with_payments_get_sqlinstance()
    db_instances.map(balkans_subscriptions_with_payments_query_on_db)
