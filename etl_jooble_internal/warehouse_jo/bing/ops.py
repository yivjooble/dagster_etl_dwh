...
def bing_get_sqlinstance(context):
    """
...
def bing_query_on_db(context, sql_instance_country_query: dict):
    """
...
def bing_job():
    instances = bing_get_sqlinstance()
    instances.map(bing_query_on_db)
