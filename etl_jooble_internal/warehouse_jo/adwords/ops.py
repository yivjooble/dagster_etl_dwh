...
def adwords_get_sqlinstance(context):
    """
...
def adwords_query_on_db(context, sql_instance_country_query: dict):
    """
...
def adwords_yesterday_job():
    instances = adwords_get_sqlinstance()
    instances.map(adwords_query_on_db)
