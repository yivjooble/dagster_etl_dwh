...
TABLE_NAME = "paid_legend_labels_channel"
SCHEMA = "traffic"
...
@op(out=DynamicOut())
def paid_legend_labels_channel_get_sqlinstance(context):
    '''
...
def paid_legend_labels_channel_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def paid_legend_labels_channel_job():
    instances = paid_legend_labels_channel_get_sqlinstance()
    instances.map(paid_legend_labels_channel_query_on_db)
