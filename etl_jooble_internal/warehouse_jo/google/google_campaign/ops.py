...
@op(out=DynamicOut())
def google_campaign_get_sql_instance(context):
    """
...
def google_campaign_query_on_db(context, sql_instance_country_query: dict):
    """
...
def google_campaign_job():
    instances = google_campaign_get_sql_instance()
    instances.map(google_campaign_query_on_db)
