...
@op(out=DynamicOut())
def google_mcc_get_sql_instance(context):
    """
...
def google_mcc_query_on_db(context, sql_instance_country_query: dict):
    """
...
def google_mcc_job():
    instances = google_mcc_get_sql_instance()
    instances.map(google_mcc_query_on_db)
