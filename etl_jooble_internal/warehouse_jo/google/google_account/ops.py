...
@op(out=DynamicOut())
def google_account_get_sql_instance(context):
    """
...
def google_account_query_on_db(context, sql_instance_country_query: dict):
    """
...
def google_account_job():
    instances = google_account_get_sql_instance()
    instances.map(google_account_query_on_db)
