...
def facebook_2018_get_sqlinstance(context):
    '''
...
def facebook_2018_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def facebook_2018_job():
    instances = facebook_2018_get_sqlinstance()
    instances.map(facebook_2018_query_on_db)
