...
TABLE_NAME = "paid_campaign_channel"
SCHEMA = "traffic"
...
@op(out=DynamicOut())
def paid_campaign_channel_get_sqlinstance(context):
    '''
...
def paid_campaign_channel_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def paid_campaign_channel_job():
    instances = paid_campaign_channel_get_sqlinstance()
    instances.map(paid_campaign_channel_query_on_db)
