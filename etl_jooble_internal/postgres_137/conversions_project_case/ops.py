...
TABLE_NAME = "conversions_project_case"
...
@op(out=DynamicOut())
def conversions_project_case_get_sqlinstance(context):
    '''
...
def conversions_project_case_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def conversions_project_case_job():
    instances = conversions_project_case_get_sqlinstance()
    instances.map(conversions_project_case_query_on_db)
