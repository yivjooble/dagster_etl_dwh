...
TABLE_NAME = "amt_scan_weekly_goal"
...
@op(out=DynamicOut())
def amt_scan_weekly_goal_get_sqlinstance(context):
    '''
...
def amt_scan_weekly_goal_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def amt_scan_weekly_goal_job():
    instances = amt_scan_weekly_goal_get_sqlinstance()
    instances.map(amt_scan_weekly_goal_query_on_db)
