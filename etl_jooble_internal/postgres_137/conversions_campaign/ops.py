...
TABLE_NAME = "conversions_campaign"
...
@op(out=DynamicOut())
def conversions_campaign_get_sqlinstance(context):
    '''
...
def conversions_campaign_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def conversions_campaign_job():
    instances = conversions_campaign_get_sqlinstance()
    instances.map(conversions_campaign_query_on_db)
