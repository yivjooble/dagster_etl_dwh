...
TABLE_NAME = "scan_flow_low_potential"
SCHEMA = "aggregation"
...
@op(out=DynamicOut())
def scan_flow_low_potential_get_sqlinstance(context):
    '''
...
def scan_flow_low_potential_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def scan_flow_low_potential_job():
    instances = scan_flow_low_potential_get_sqlinstance()
    instances.map(scan_flow_low_potential_query_on_db)
