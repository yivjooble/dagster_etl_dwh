...
@op(out=DynamicOut())
def conversions_joveo_get_sqlinstance(context):
    '''
...
def conversions_joveo_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def conversions_joveo_job():
    instances = conversions_joveo_get_sqlinstance()
    instances.map(conversions_joveo_query_on_db)
