...
TABLE_NAME = "domains_per_user_daily"
SCHEMA = "imp"
...
@op(out=DynamicOut())
def domains_per_user_daily_get_sql_instance(context):
    """
...
def domains_per_user_daily_query_on_db(context, sql_instance_country_query: dict):
    """
...
def domains_per_user_daily_job():
    instances = domains_per_user_daily_get_sql_instance()
    instances.map(domains_per_user_daily_query_on_db)
