...
TABLE_NAME = "auction_user_target_action"
SCHEMA = "aggregation"
...
@op(out=DynamicOut())
def auction_user_target_action_get_sqlinstance(context):
    '''
...
def auction_user_target_action_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def auction_user_target_action_job():
    instances = auction_user_target_action_get_sqlinstance()
    instances.map(auction_user_target_action_query_on_db)
