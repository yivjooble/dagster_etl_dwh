from dagster import DynamicOut, fs_io_manager, job, op
...
TABLE_NAME = "exclude_ppc_traffic_request"
SCHEMA = "imp"
...
@op(out=DynamicOut())
def exclude_ppc_traffic_request_get_sqlinstance(context):
    '''
...
def exclude_ppc_traffic_request_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def exclude_ppc_traffic_request_job():
    instances = exclude_ppc_traffic_request_get_sqlinstance()
    instances.map(exclude_ppc_traffic_request_query_on_db)
