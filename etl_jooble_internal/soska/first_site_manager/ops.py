...
@op(out=DynamicOut())
def first_site_manager_get_sqlinstance(context):
    '''
...
def first_site_manager_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def first_site_manager_job():
    instances = first_site_manager_get_sqlinstance()
    instances.map(first_site_manager_query_on_db)
