...
TABLE_NAME = "subscription_model_metrics_raw"
SCHEMA = "aggregation"
...
def subscription_model_metrics_raw_get_sqlinstance(context):
    '''
...
def subscription_model_metrics_raw_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def subscription_model_metrics_raw_job():
    instances = subscription_model_metrics_raw_get_sqlinstance()
    instances.map(subscription_model_metrics_raw_query_on_db)
