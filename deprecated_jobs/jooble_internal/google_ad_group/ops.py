...
@op(out=DynamicOut())
def google_ad_group_get_sql_instance(context):
    """
...
def google_ad_group_query_on_db(context, sql_instance_country_query: dict):
    """
...
def google_ad_group_job():
    instances = google_ad_group_get_sql_instance()
    instances.map(google_ad_group_query_on_db)
