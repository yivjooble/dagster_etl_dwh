...
TABLE_NAME = "paid_traf_cost_2023"
SCHEMA = "traffic"
...
@op(out=DynamicOut())
def paid_traf_cost_2023_get_sqlinstance(context):
    '''
...
def paid_traf_cost_2023_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def paid_traf_cost_2023_job():
    instances = paid_traf_cost_2023_get_sqlinstance()
    instances.map(paid_traf_cost_2023_query_on_db)
