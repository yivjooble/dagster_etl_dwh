...
@op(out=Out(str))
def session_account_get_sql_query(context) -> str:
...
def session_account_get_sqlinstance(context, query):
    '''
...
def session_account_query_on_db(context, sql_instance_country_query: dict) -> list:
    '''
...
def session_account_delete_history_data(context, **kwargs):
    """
    Delete historical data for email .
...
def session_account_job():
    ...
    None
    """
    query = session_account_get_sql_query()
    instances = session_account_get_sqlinstance(query)
    file_paths = instances.map(session_account_query_on_db).collect()
