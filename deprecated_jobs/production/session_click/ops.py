...
def session_click_delete_old_data(context, save_result):
    # Get sql query from .sql file.
...
def session_click_job():
    ...
    save_result = session_click_save_df_to_dwh(file_paths, delete)
    # session_click_delete_old_data(save_result)