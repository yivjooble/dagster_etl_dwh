...
TABLE_NAME = "auction_external_stat"
SCHEMA = "imp"
...
def auction_external_stat_get_sqlinstance(context):
    '''
...
def auction_external_stat_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def auction_external_stat_job():
    instances = auction_external_stat_get_sqlinstance()
    instances.map(auction_external_stat_query_on_db)
