...
TABLE_NAME = "snap_email_account_test"
SCHEMA = "an"
PATH_TO_DATA = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data")


@op(out=Out(str))
def snap_email_account_test_get_sql_query(context) -> str:
...
def snap_email_account_test_get_sqlinstance(context, query):
    '''
...
def snap_email_account_test_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def snap_email_account_test_job():
    """
    This function executes the snap_email_account_test job.

    It retrieves a SQL query using the snap_email_account_test_get_sql_query function,
    gets SQL instances using the snap_email_account_test_get_sqlinstance function,
    and maps the snap_email_account_test_query_on_db function to each instance.
    """
    query = snap_email_account_test_get_sql_query()
    instances = snap_email_account_test_get_sqlinstance(query)
    instances.map(snap_email_account_test_query_on_db)