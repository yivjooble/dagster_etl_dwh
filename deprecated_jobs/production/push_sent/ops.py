...
def push_sent_get_sqlinstance(context):
    """
...
def push_sent_query_on_db(context, sql_instance_country_query: dict):
    '''
...
def push_sent_job():
    instances = push_sent_get_sqlinstance()
    instances.map(push_sent_query_on_db)
