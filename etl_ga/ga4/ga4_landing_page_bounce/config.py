...
["ae.jooble.org", "properties/357164452"], ["ar.jooble.org", "properties/356179970"], ["at.jooble.org", "properties/356598115"], 
...
["my.jooble.org", "properties/357473059"], ["ng.jooble.org", "properties/356871575"], ["nl.jooble.org", "properties/356880961"], 
...
["tw.jooble.org", "properties/356854289"], ["ua.jooble.org", "properties/354983946"], ["uk.jooble.org", "properties/356849346"], 
...
blog_property_list = [
    #["fr.jooble.org", "properties/324833662"] #Jooble Special Projects,
    #["ca.jooble.org", "properties/412240191"] #Jooble Special Projects
    ["fr.jooble.org", "properties/356631342"],
    ["ca.jooble.org", "properties/356638251"],
]

career_advice_property_list = [
    #["uk.jooble.org", "properties/280108814"], #Jooble Special Projects
    ["uk.jooble.org", "properties/356849346"],
    ["us.jooble.org", "properties/356846637"]  #GA4
]

career_property_list = [
    ["fr.jooble.org", "properties/356631342"],
    ["ca.jooble.org", "properties/356638251"],
    ["pl.jooble.org", "properties/357485014"],
]
...
company_property_list = [
    ...
    ["ca.jooble.org", "properties/356638251"],
    ["pl.jooble.org", "properties/357485014"],
    ["de.jooble.org", "properties/356639269"],
]

recruiting_property_list = [
    ["ua.jooble.org", "properties/375771174"], #DTE
]

ea_property_list = [
    ["ua.jooble.org", "properties/375771174"], #DTE
    ["hu.jooble.org", "properties/364864984"], #DTE
    ["ro.jooble.org", "properties/375781570"] #DTE
]



country_domain_to_property_id = dict(property_list)
blog_countries_property_id = dict(blog_property_list)
career_advice_property_id = dict(career_advice_property_list)
company_property_id = dict(company_property_list)
career_property_id = dict(career_property_list)
recruiting_property_list = dict(recruiting_property_list)
ea_property_list = dict(ea_property_list)

# key: Table name in DWH

request_params = {
    'ga4_landing_page_bounce': {
        'dimensions': [
            {'name': 'date'},
            {'name': 'landingPage'},
            {'name': 'sessionSource'},
