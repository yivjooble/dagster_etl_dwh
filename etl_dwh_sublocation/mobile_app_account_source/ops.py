...
TABLE_NAME = 'account_source'
SCHEMA = 'mobile_app'

YESTERDAY_DATE = (datetime.now().date() - timedelta(1)).strftime('%Y-%m-%d')

PROCEDURE_CALL = "call mobile_app.prc_account_source(%s);"
...
def mobile_app_account_source_query_on_db(context):
...
def mobile_app_account_source_job():
    mobile_app_account_source_query_on_db()
