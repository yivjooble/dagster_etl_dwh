...
TABLE_NAME = 'search_seo_breadcrumbs'
SCHEMA = 'traffic'

PROCEDURE_CALL = 'call traffic.prc_search_seo_breadcrumbs();'
...
def search_seo_breadcrumbs_query_on_db(context):
...
def search_seo_breadcrumbs_job():
    search_seo_breadcrumbs_query_on_db()
